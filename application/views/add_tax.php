...
<div class="row">
    <div class="col-md-8">
      <div class="box box-info">
                ...
                <!-- form start -->
                <form method="post" action="<?php echo site_url();?>/tax/save" enctype="multipart/form-data">
                    <div class="box-body">
					<div class="form-group">
                      <label class="col-sm-4 control-label" for="inputEmail3">Name</label>
                      <div class="col-sm-8">
                        <input type="text" placeholder="Tax Name" id="tax_name" name="tax_name" value="" class="form-control">
                      </div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" placeholder="Tax Rate" id="tax_rate" name="tax_rate" value="" class="form-control">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-4 control-label" for="inputEmail3">Active?</label>
                      <div class="col-sm-8">
                        <input type="radio" id="active_yes" name="is_active" value="1" checked="checked" style="display:inline;"><label for="active_yes">Yes</label>
						<input type="radio" id="active_yes" name="is_active" value="0" style="display:inline;"><label for="active_no">No</label>
                      </div>
                    </div>
                  </div><!-- /.box-body -->
