...
<div class="row">
    <div class="col-md-8">
      <div class="box box-info">
                ...
                <!-- form start -->
                <form method="post" action="<?php echo site_url();?>/coupons/save" enctype="multipart/form-data">
                    <div class="box-body">
					<div class="form-group">
                      <label class="col-sm-4 control-label" for="inputEmail3">Code</label>
                      <div class="col-sm-8">
                        <input type="text" placeholder="Coupon Code" id="coupon_code" name="coupon_code" value="" class="form-control">
                      </div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="radio" id="discount_type_fixed" name="discount_type" value="1" checked="checked" style="display:inline;"><label for="discount_type_fixed">Fixed</label>
						<input type="radio" id="discount_type_percentage" name="discount_type" value="2" style="display:inline;"><label for="discount_type_percentage">Percentage</label>
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-4 control-label" for="inputEmail3">Discount Value</label>
                      <div class="col-sm-8">
                        <input type="number" placeholder="Discount Value" id="discount_value" name="discount_value" value="" class="form-control">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-4 control-label" for="inputEmail3">Expire Date</label>
                      <div class="col-sm-8">
                        <input type="text" placeholder="Expire Date" id="expire_date" name="expire_date" value="" class="form-control">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-4 control-label" for="inputEmail3">Uses Per Person</label>
                      <div class="col-sm-8">
                        <input type="number" placeholder="Uses Per Person" id="coupon_uses" name="coupon_uses" value="-1" class="form-control">
                      </div>
                    </div>
					<div class="form-group">
                      <label class="col-sm-4 control-label" for="inputEmail3">Minimum Purchase</label>
                      <div class="col-sm-8">
                        <input type="number" placeholder="Minimum Purchase" id="minimum_purchase" name="minimum_purchase" value="0" class="form-control">
                      </div>
                    </div>
                  </div>
